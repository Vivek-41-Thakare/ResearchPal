...
def run_test():
    # 1. Target a tiny 1-page dummy PDF (no figures/tables)
    pdf_url = "https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf"
    title = "Dummy_1_Page_Paper"
    print(f"🔗 Target PDF Link: {pdf_url}")
    
    # 2. Ingest the paper
    print(f"\n🚀 Step 1: Requesting ingestion/parsing for '{title}'...")
    headers = {
    ...
    chat_payload = {
        "query": "Does this document mention it is a dummy file? Keep it under 2 sentences.",
        "document_id": doc_id,
        "chat_history": []
    }
